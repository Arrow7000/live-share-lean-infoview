...
- Widgets **render**, and infoview actions work on the guest (go-to-source,
  copy-to-comment, apply-edit, "Restart File"). Caveats: snippet edits insert
  literally (no placeholder expansion), and "Restart File" briefly focuses the
  file on the host.
